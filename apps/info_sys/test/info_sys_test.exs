defmodule InfoSysTest do
  ...
  defmodule TestBackend do
    ...
    def fetch("boom", _ref, _owner_, _limit) do
      raise "Here comes the Boom!"
    end
  end
  ...
  test "compute/2 with timeout returns no results and kill servers" do
